    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-20 text-center">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-violet-600/10 blur-[120px]"
        />
        <div className="absolute top-40 right-0 h-[300px] w-[300px] rounded-full bg-fuchsia-600/5 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-900/50 px-4 py-1.5 text-xs text-zinc-400"
        >
